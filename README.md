...
**Refined version of vue-monaco, originally published by egoist.**

[![NPM version](https://img.shields.io/npm/v/vue-monaco-refined.svg?style=flat)](https://npmjs.com/package/vue-monaco-refined) [![NPM downloads](https://img.shields.io/npm/dm/vue-monaco-refined.svg?style=flat)](https://npmjs.com/package/vue-monaco-refined)
...
```bash
npm install vue-monaco-refined
```

Or

```bash
yarn add vue-monaco-refined
```
...
<script>
import MonacoEditor from 'vue-monaco-refined'
...
<html>
  ...
  <body>
    ...
    <script src="https://unpkg.com/vue-monaco-refined"></script>
